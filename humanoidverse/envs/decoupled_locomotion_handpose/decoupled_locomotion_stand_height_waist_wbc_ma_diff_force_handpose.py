...
import torch
from humanoidverse.envs.decoupled_locomotion_handpose.decoupled_locomotion_stand_height_waist_wbc_ma_handpose import LeggedRobotDecoupledLocomotionStanceHeightWBCHandPoses
...
DEBUG = False
class LeggedRobotDecoupledLocomotionStanceHeightWBCHandPosesForce(LeggedRobotDecoupledLocomotionStanceHeightWBCHandPoses):
